...
export default function LoginScreen() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
            ...
            <header className="bg-[#007A33] text-white p-4 shadow-md z-10 relative">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center">
                        <div className="font-extrabold text-2xl tracking-wider mr-3">CFE</div>
                        <div className="text-sm border-l-2 border-white/20 pl-3 font-light tracking-wide">
            ...
            <main className="flex-grow flex items-center justify-center p-4 md:p-8 relative">
                ...
                <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-[#007A33]/10 to-transparent"></div>

                {/* Tarjeta Principal (UI Moderna) */}
                <div className="bg-white rounded-3xl shadow-2xl w-full max-w-5xl flex flex-col md:flex-row overflow-hidden border border-white/40 backdrop-blur-sm z-10">
                    
                    {/* LADO IZQUIERDO: Información + Espacio para Imagen */}
                    <div className="md:w-1/2 bg-gradient-to-br from-slate-50 to-slate-100 p-8 md:p-12 flex flex-col justify-between border-b md:border-b-0 md:border-r border-slate-200">
                        <div>
                        ...
                        {/* ESPACIO PARA IMAGEN */}
                        <div className="my-6 flex-grow flex items-center justify-center overflow-hidden rounded-2xl">
                            <img 
                        ...
                        <div className="w-full max-w-sm mx-auto">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="pt-2">
                                    ...
                                    >
                                        {loading ? (
                                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24  cursor-pointer">
            ...
            {/* Footer Institucional Moderno con Toque Verde */}
            <footer className="bg-white/80 backdrop-blur-md border-t-2 border-[#007A33]/20 mt-auto z-10 relative overflow-hidden">
                {/* Degradado verde sutil en el fondo del footer */}
                ...
                <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 relative z-10">
                    ...
                    {/* Lado Derecho: Enlaces con Iconos y Versión */}
