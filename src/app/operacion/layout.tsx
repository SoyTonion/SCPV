...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans">
      ...
      {/* HEADER: Adaptado al mismo diseño minimalista e institucional */}
      <header className="bg-white/80 backdrop-blur-md border-b-4 border-[#007A33]/20 z-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto py-2 px-4 flex justify-between items-center relative z-10">
          ...
          <div className="flex items-center space-x-3 text-sm">
            ...
            {/* Información del Usuario Logueado (Se oculta en celular para ahorrar espacio) */}
      ...
      {/* Contenido principal (Aquí renderiza el escáner o el formulario de combustible) */}
