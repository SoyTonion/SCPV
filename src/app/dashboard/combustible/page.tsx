        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-white/80 backdrop-blur-md border border-[#007A33]/30 text-[#007A33] font-bold rounded-xl py-2.5 px-4 shadow-sm hover:bg-[#007A33]/5 hover:border-[#007A33]/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
